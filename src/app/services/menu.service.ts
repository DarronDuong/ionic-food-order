...
export class MenuService {
  ...
  private menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      categoryId: 1,
      title: 'Spring Rolls',
      imageUrl: 'assets/menu-photos/SR.png',//'https://steamykitchen.com/wp-content/uploads/2012/07/chinese-chicken-egg-rolls-recipe-8473.jpg',
      amount: 4,
      price: 7.9,
      ingredients: []
    },
    {
      ...
      imageUrl: 'assets/menu-photos/COLD-ROLL.png',//'https://www.veganricha.com/wp-content/uploads/2018/08/Vegan-Spring-rolls-with-Peanut-Sauce-veganricha-1560-2.jpg',
      amount: 2,
      price: 6.9,
      ingredients: []
    },
    {
      ...
      imageUrl: 'assets/menu-photos/COLD-ROLL.png',//'https://www.tasteofhome.com/wp-content/uploads/2017/10/Asian-Spring-Rolls_exps29721_CM2043886D08_16_6bC_RMS-696x696.jpg',
      amount: 2,
      price: 6.9,
      ingredients: []
    },
    {
      ...
      imageUrl: 'assets/menu-photos/DUCK-WRAP.jpg',//'https://food-images.files.bbci.co.uk/food/recipes/duckpancakeswithhois_67779_16x9.jpg',
      amount: 4,
      price: 8.9,
      ingredients: []
    },
    ...
    //#region Soup
    {
      ...
      categoryId: 3,
      title: 'Laksa (Spicy)',
      imageUrl: 'assets/menu-photos/LAKSA.jpg',//'https://cdn77-s3.lazycatkitchen.com/wp-content/uploads/2019/01/vegan-laksa-bowl-800x1200.jpg',
      amount: null,
      price: 14.5,
    ...
    },
    {
      ...
      imageUrl: 'assets/menu-photos/BEEF-PHO.jpg',//'https://www.deliciouseveryday.com/wp-content/uploads/Vegan-Pho-1-7-600x600.jpg',
      amount: null,
      price: 13.9,
  ...
  getCategoryMenuItems(categoryId: number) {
    return of(this.menuItems.filter(i => i.categoryId === categoryId));
  }
  ...
  getItemIngredients(ingredientIds: number[]) {
    return this.ingredients.filter(i => ingredientIds.includes(i.ingredientId));
  }
